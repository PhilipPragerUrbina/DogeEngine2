...
namespace Doge {
     ...
     * OpenGL image data
     */
    class OpenGLTexture : public ResourceData{
    private:
    ...
    public:
         ...
         */
        OpenGLTexture(Resource<Image> image){
            //Bind texture
         ...
         */
        OpenGLTexture(ResourceManager* manager, const std::string& ID) : OpenGLTexture(manager->requestResource<Image>(ID)){}
